...
class StrRes {
  ...
  static String get tapTooShort => '长按时间过短'.tr;

  static String get iagree => 'iagree'.tr;

  static String get userAgreement => 'userAgreement'.tr;

  static String get userPrivacy => 'userPrivacy'.tr;

  static String get agreeand => 'agreeand'.tr;

  static String get noregister => 'noregister'.tr;
  ...
  static String get mineMoney => '我的钱包'.tr;

  static String get mineAddressBook => '通讯录'.tr;

  static String get mineOrders => '我的订单'.tr;

  static String get mineAgreement => '用户协议'.tr;

  static String get minePrivacy => '隐私政策'.tr;

  static String get mineOpinion => '意见反馈'.tr;

  static String get mineSetting => '设置'.tr;

  static String get weDoNum => '微办号'.tr;

  static String get myCore => '我的积分'.tr;

  static String get myPayQrCode => '收付款'.tr;

  static String get moneyDescribe =>
      '政府补贴通过积分发放，积分可在线下指定商家，购买商品。可相互转账，可在指定银行提现。'.tr;

  static String get oldPeopleTel => '老年人客服热线'.tr;

  static String get oldPeopleTelNum => '0991-12681231'.tr;

  static String get momentsRange => '邻里圈查看范围'.tr;

  static String get customerCall => '您确定要拨打客服电话吗?'.tr;

  static String get time => '时间'.tr;

  static String get all => '全部'.tr;

  static String get halfYear => '最近半年'.tr;

  static String get lastMonth => '最近一个月'.tr;

  static String get lastThreeDays => '最近三天'.tr;

  static String get settingVoice => '语音图标'.tr;

  static String get building => '正在开发中...'.tr;

  static String get commit => '发布'.tr;

  static String get commitMoments => '发布邻里圈'.tr;

  static String get advisory => '村务公告'.tr;

  static String get second => "''".tr;

  static String get contentModeration => "内容审核".tr;

  static String get contentFail => "不通过".tr;

  static String get contentPass => "通过".tr;

  static String get surePass => "你确定要通过这条邻里圈信息吗?".tr;

  static String get sureNoPass => "你确定要禁止这条邻里圈信息吗?".tr;

  static String get sureDelete => "你确定要删除这条邻里圈信息吗?".tr;

  static String get sureDeleteOrder => "你确定要删除这条订单信息吗?".tr;

  static String get load => "加载中".tr;

  static String get szwz => "所在位置".tr;

  static String get txsk => "提醒谁看".tr;

  static String get skyk => "谁可以看".tr;

  static String get nrlx => "内容类型 ".tr;

  static String get timelimit => "时限 ".tr;

  static String get ad => "广告 ".tr;

  static String get life => "生活 ".tr;

  static String get help => "求助 ".tr;

  static String get zhangdan => '账单'.tr;

  static String get someone_moments => '邻里圈列表'.tr;

  static String get micwork_number => '请输入微办号'.tr;

  static String get redeemcode => '兑换码'.tr;

  static String get redeemcontext => "扫码以兑换惠农积分".tr;

  static String get changezz => "切换组织".tr;

  static String get jijifenzi =>"积极分子".tr;
  static String get dangyuan =>"党员".tr;
  static String get yubeidangyuan =>"预备党员".tr;
  static String get ohtner =>"其它".tr;
  static String get zzmianmao =>"政治面貌".tr;
  static String get onlineParty =>"线上党校".tr;
  static String get resendToMoments =>"转发到邻里圈".tr;
  static String get sureResendToMoments =>"确认转发到邻里圈吗？".tr;

  static String get bugnow =>"立即购买".tr;
  static String get buglater =>"待支付".tr;

  static String get chatfrist =>"交易前聊一聊".tr;
  static String get micropaynum =>"微办积分支付".tr;
  static String get pay =>"支付".tr;
  static String get paynum =>"付款金额".tr;
  static String get tuinum =>"退款金额".tr;
  static String get paystate =>"支付状态".tr;
  static String get paymethod =>"支付方式".tr;
  static String get tuimethod =>"退款方式".tr;
  static String get tuinotice =>"退款到账通知".tr;
  static String get nopay =>"您有未支付的订单".tr;
  static String get weihu =>"系统维护中，请稍后重试".tr;
  static String get wangluo =>"网络错误，请稍后重试".tr;

  static String get priceRmb => "价格:".tr;
}
